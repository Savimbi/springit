package com.dorna.dornablog.bootstrap;
...
import com.dorna.dornablog.repositorys.CommentRepository;
...
public class DatabaseLoader implements CommandLineRunner{
	...
	private void addUsersAndRoles() {
	    ...
	    User user = new User("user@gmail.com",secret,true,"Joe","User","joedir");
	    ...
	    User master = new User("master@gmail.com",secret,true,"Super","User","masteruser");
